...
public class activity_places_Japanese extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_places_japanese);
        ...
        i2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String info = "https://chandigarh.tourismindia.co.in/japanese-garden-chandigarh";
        ...
        i3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Uri gmmIntentUri = Uri.parse("https://www.google.com/maps/place/Japnese+Garden/@30.7045255,76.7842513,15z/data=!4m5!3m4!1s0x0:0x1abac4d7ff03dae6!8m2!3d30.7045255!4d76.7842513");
