...
public class activity_shopping_Rehri extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shopping_rehri);
        ...
        i2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String info = "https://timesofindia.indiatimes.com/topic/Sector-19-rehri-market";
        ...
        i3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Uri gmmIntentUri = Uri.parse("https://www.google.com/maps/place/Rehri+Market/@30.7446107,76.7619893,15z/data=!4m2!3m1!1s0x0:0x8556efb745ca3e4d?sa=X&ved=2ahUKEwjjm7mtxY3yAhW68HMBHejQD-8Q_BIwE3oECEoQBQ");
